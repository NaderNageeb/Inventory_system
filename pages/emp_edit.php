...
$opt .= "</select>";
        ...
        $query = 'SELECT EMPLOYEE_ID, FIRST_NAME,GENDER,LAST_NAME, EMAIL, PHONE_NUMBER, j.JOB_TITLE, HIRED_DATE FROM employee e  join job j on j.JOB_ID=e.JOB_ID WHERE EMPLOYEE_ID ='.$_GET['id'];
        $result = mysqli_query($db, $query) or die(mysqli_error($db));
